...
class MEmp{
    ...
    public function getAll(){
        try{
            $sql = "SELECT idemp, nomemp, razemp, nitemp, diremp, telemp, emaemp, logo, idusu, fec_crea, fec_actu, act FROM empresa";
            $modelo = new conexion();
    ...
    public function getOne(){
        try{
            $sql = "SELECT idemp, nomemp, razemp, nitemp, diremp, telemp, emaemp, logo, idusu, fec_crea, fec_actu, act FROM empresa WHERE idemp=:idemp";
            $modelo = new conexion();
            $conexion = $modelo->get_conexion();
            $result = $conexion->prepare($sql);
            $idemp = $this->getIdemp();
    ...
    public function save(){
        try{
            $sql = "INSERT INTO empresa(nomemp, razemp, nitemp, diremp, telemp, emaemp, logo, idusu, fec_crea, fec_actu, act) VALUES (:nomemp, :razemp, :nitemp, :diremp, :telemp, :emaemp, :logo, :idusu, :fec_crea, :fec_actu, :act) ";
            $modelo = new conexion();
            $conexion = $modelo->get_conexion();
            $result = $conexion->prepare($sql);
    ...
    public function edit(){
        try{
            $sql = "UPDATE empresa SET nomemp=:nomemp, razemp=:razemp, nitemp=:nitemp, diremp=:diremp, telemp=:telemp, emaemp=:emaemp, logo=:logo, idusu=:idusu, fec_crea=:fec_crea, fec_actu=:fec_actu, act=:act WHERE idemp=:idemp";
            $modelo = new conexion();
            $conexion = $modelo->get_conexion();
            $result = $conexion->prepare($sql);
            $idemp = $this->getIdemp();
