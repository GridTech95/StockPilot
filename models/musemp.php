...
class Musemp {
    ...
    // Editar fecha de creación (o info si lo requiere)
    public function edit() {
        try {
            $sql = "UPDATE usuario_empresa SET fec_crea=:fec_crea
    ...
    public function del() {
        try {
            $sql = "DELETE FROM usuario_empresa WHERE idusu=:idusu AND idemp=:idemp";
            $modelo = new conexion();
            $conexion = $modelo->get_conexion();
            $result = $conexion->prepare($sql);
            $idusu = $this->getIdusu();
